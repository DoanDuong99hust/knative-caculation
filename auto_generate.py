...
if __name__ == "__main__":
    ...
    for target_pod in target_pods_scale:
        for rep in range(1, repeat_time + 1, 1):
            print("Target pod: {}, Repeat time: {}/{}, Instance: {}, Target video: {}, Image: {}".format(
                target_pod,rep,repeat_time,instance,target_video,detection_image))
            cmd = '/usr/bin/python3 /home/controller/knative-caculation/main_rebuild.py master {} {} {} {} {} {}>> log.txt'.format(
                str(target_pod), str(warming_status_seconds), str(rep), str(instance), str(target_video), str(detection_image))
