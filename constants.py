...
# QUERY
VALUES_CPU_QUERY = "100-(avg%20by%20(instance,%20job)%20(irate(node_cpu_seconds_total{mode=%22idle%22,%20job=%22node_exporter%22,%20instance=%22192.168.101.101:9100%22}[30s])*100))"
VALUES_PODS_QUERY = "kubelet_running_pods{kubernetes_io_hostname='server'}"
VALUES_MEMORY_QUERY = "(node_memory_MemTotal_bytes{job='node_exporter',instance='192.168.101.101:9100'}-node_memory_MemAvailable_bytes{job='node_exporter',instance='192.168.101.101:9100'})/(1024*1024)"
RUNNING_PODS_QUERY = "kubelet_running_pods{kubernetes_io_hostname='server'}"
...
# COMMAND
START_UMMETER_CMD = '/usr/bin/python3 /home/controller/knative-caculation/usbmeter --addr 00:16:A5:00:0F:65 --out /home/luongtrann/hanoi/code/data_ummeter/data_ummeter_{}_{} --time {}'
UPDATE_REPLICAS_CMD = '/usr/bin/python3 /home/controller/knative-caculation/main.py changevalue {} {} {}'
